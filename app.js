...
// 展示奖池与可中奖项分开；中奖记录继续使用五项奖品的稳定索引。
const DISPLAY_PRIZES = [
 {name:'张杰演唱会门票',lines:['张杰演唱会门票']},
 ...
 ...PRIZES.map((p,winIndex)=>({...p,winIndex,lines:[p.name,p.detail]}))
];
